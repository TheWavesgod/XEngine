...
VK::VkBase::~VkBase()
{
    ...
    if (debugMessenger)
    {
        ...
        if (DestroyDebugUtilsMessenger) DestroyDebugUtilsMessenger(instance, debugMessenger, nullptr);
    }

    vkDestroyInstance(instance, nullptr);
}

VkResult VK::VkBase::CreateInstance(VkInstanceCreateFlags flags)
{
...
VkResult VK::VkBase::CheckInstanceLayers(std::span<const char*> layersToCheck)
{
...
VkResult VK::VkBase::CheckInstanceExtensions(std::span<const char*> extensionsToCheck, const char* layerName) const
{
...
VkResult VK::VkBase::CreateDebugMessenger()
{
